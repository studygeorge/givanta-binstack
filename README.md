...
Результат: боковина **272 → 130 см³ (−52 %)**, комплект целиком
779 см³ ≈ 445 г PETG при 15 % заполнения вместо ~600 г. Время печати
боковины падает примерно во столько же раз.

Дальше облегчать можно задние стенки лотков (ещё около 60 см³) — скажи,
если нужно.
