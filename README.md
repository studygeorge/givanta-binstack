...
комплект целиком 771 см³. По факту слайсинга это **503 г PETG и 31 ч 39 мин** печати (см. замеры ниже).
...
|---|---|---|---|---|
| боковина-ферма | 0,25 | 2 | **Lightning 5 %** | 2 / 2 |
| лоток | 0,25 | 2 | Lightning 5 % | 4 / 3 |
...
**Какой узор выгоднее — замерено, а не прикинуто.** Боковина-ферма
нарезана в Creality Print CLI под PETG, слой 0,25, 2 периметра, 3/3 корки,
заполнение 10 %:

| Узор | Время | Пластик |
|---|---|---|
| **Lightning** | **7 ч 10 мин** | **65,1 г** |
| Grid | 7 ч 54 мин | 75,2 г |
| Rectilinear | 7 ч 54 мин | 75,2 г |
| Gyroid | 7 ч 59 мин | 76,0 г |
| Honeycomb | 8 ч 48 мин | 79,0 г |

Lightning выигрывает и по времени, и по расходу: минус 11 г и 49 минут
против Gyroid на каждой боковине. Grid и Rectilinear в этой детали дают
идентичный результат, соты — худший вариант по обоим параметрам.

Дожимаем корками и процентом (тот же Lightning):

| Настройка | Время | Пластик |
|---|---|---|
| 10 %, корки 3/3 | 7 ч 10 мин | 65,1 г |
| 10 %, корки 2/2 | 6 ч 58 мин | 63,5 г |
| 5 %, корки 3/3 | 6 ч 30 мин | 62,5 г |
| **5 %, корки 2/2** | **6 ч 17 мин** | **60,8 г** |

Итог: **Lightning 5 %, корки 2/2** — 60,8 г и 6 ч 17 мин против 76 г и
8 часов у Gyroid 10 % с корками 3/3. Экономия 15 г и 1 ч 40 мин на боковину,
то есть **30 г и больше трёх часов на пару**.

Почему Lightning здесь безопасен, хотя обычно он «несущим» не считается:
в раскосе шириной 4 мм полость всего 2,3 мм, и жёсткость там дают два
периметра, а не заполнение. Для штанг каркаса, где сечение 12 × 10 мм,
заполнение работает по-настоящему — там ставим Gyroid 15 %.

**Весь комплект, замерено по каждой детали** (профили из таблицы выше):

| Деталь | Шт | Время / шт | Грамм / шт | Время всего | Грамм всего |
|---|---|---|---|---|---|
| Боковина-ферма | 2 | 6 ч 17 мин | 60,8 | 12 ч 34 мин | 121,7 |
| **Лоток** | 3 | 4 ч 20 мин | **98,0** | 12 ч 59 мин | **294,1** |
| Перегородка | 6 | 36 мин | 8,7 | 3 ч 38 мин | 52,0 |
| Штанга | 2 | 58 мин | 14,7 | 1 ч 56 мин | 29,3 |
| Планка логотипа | 1 | 30 мин | 6,1 | 30 мин | 6,1 |
| **Итого** | **14** | | | **31 ч 39 мин** | **503 г** |

Важный вывод: после облегчения боковин главным потребителем стали **лотки —
58 % пластика и 41 % времени всего комплекта**. Причина в дне: 213 × 117 мм
при толщине 2,4 мм это 10 слоёв, из которых при корках 4/3 семь идут
сплошной заливкой, то есть дно печатается почти монолитом независимо от
процента заполнения. Настройками это не лечится, только геометрией
(утоньшить середину дна и добавить рёбра жёсткости) — скажи, если делать.
