...
Ферма покрывает и клинья под наклонными полозьями сверху и снизу, а у
лотков треугольными проёмами облегчены задние стенки (низ борта 18 мм
оставлен сплошным, чтобы мелочь не просыпалась).

Результат: боковина **272 → 123 см³ (−55 %)**, лоток 132 → 123 см³,
комплект целиком **738 см³ ≈ 422 г** PETG при 15 % заполнения вместо ~600 г.

### Профиль печати: минимум пластика и времени

Числа под Creality K2, сопло 0,4, PETG 230–240 °C / стол 70–80 °C.
Ферменные детали почти целиком состоят из периметров, поэтому заполнение
можно опустить до минимума — на прочность это почти не влияет.

| Деталь | Слой | Стенки | Заполнение | Дно/верх |
|---|---|---|---|---|
| боковина-ферма | 0,25 | 2 | **Lightning 5 %** | 3 / 3 |
| лоток | 0,25 | 2 | Gyroid 10 % | 4 / 3 |
| перегородка (2,4 мм) | 0,25 | 3 | не нужно: деталь целиком из периметров | 2 / 2 |
...
Почему Lightning для боковин: этот узор строит опоры только под верхней
коркой и почти не тратит материал в теле детали — для раскосов шириной
4–5 мм, где периметры и так смыкаются, он даёт минимальный расход.
